...
jog = False # 怠速运动进行时为 True
jog_z_threshold = 10 # 怠速开始/结束后的最小 Z 轴偏移
...
def drawArc(x0, y0, x1, y1, x2, y2):
    ...
    if arc_theta1 < center_theta < arc_theta2 or arc_theta1 > center_theta > arc_theta2:    # 如果弧度小于 180 度
